  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'thank-you-star-1': 'thank-you-star-1 0.25s linear 0.9s',
        'thank-you-star-2': 'thank-you-star-2 0.25s linear 0.9s',
        'page-fade': 'page-fade 0.35s linear',
        heart: 'heart 1s ease-in',
      ...
      keyframes: {
        ...
        heart: {
          ...
          '50%': { transform: 'scale(2) translateX(-10rem)', 'z-index': '10' },
        },
        'bg-color': {
